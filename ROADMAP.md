...
| 章 | 标题 | 它回答的核心问题 |
|:--:|------|------------------|
| 01 | 编程语言发展史 | 语言为何从机器码一路演进到高级语言？ |
| 02 | 程序是什么 | 一段代码如何变成 CPU 执行的动作？ |
| 03 | 编译器 | 源代码如何被翻译成机器码？ |
| 04 | 解释器 | 不编译也能运行，代价是什么？ |
| 05 | 虚拟机 | JVM / CLR 为何存在，"一次编写到处运行"如何实现？ |
| 06 | 运行时 | 程序运行时，语言在背后替你做了什么？ |
| 07 | 类型系统 | 类型到底约束了什么？静态与动态各图什么？ |
