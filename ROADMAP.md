...
| 章 | 标题 | 它回答的核心问题 |
|:--:|------|------------------|
| 23 | [类](./docs/Part4-OOP/23-class.md) | 为什么需要把数据和行为绑在一起？ |
| 24 | [对象](./docs/Part4-OOP/24-object.md) | 对象在内存里如何布局？ |
| 25 | [封装](./docs/Part4-OOP/25-encapsulation.md) | 隐藏实现细节为何重要？ |
| 26 | [继承](./docs/Part4-OOP/26-inheritance.md) | 复用与"is-a"关系的代价是什么？ |
| 27 | [多态](./docs/Part4-OOP/27-polymorphism.md) | vtable / 动态派发如何实现"同一接口，不同行为"？ |
| 28 | [接口](./docs/Part4-OOP/28-interface.md) | 为什么需要契约，而非实现？ |
| 29 | [泛型](./docs/Part4-OOP/29-generics.md) | 类型参数化如何兼顾复用与安全（模板 vs 泛型 vs 鸭子类型）？ |
| 30 | [反射](./docs/Part4-OOP/30-reflection.md) | 运行时窥探/操作类型有何用、有何险？ |
...
| 章 | 标题 | 它回答的核心问题 |
|:--:|------|------------------|
| 46 | [数据库](./docs/Part7-Database/46-database.md) | 内存与文件之外，为什么还需要数据库？ |
| 47 | [SQL](./docs/Part7-Database/47-sql.md) | 声明式查询如何表达"要什么，而非怎么做"？ |
| 48 | [事务](./docs/Part7-Database/48-transaction.md) | ACID 如何保证一致性？ |
| 49 | [索引](./docs/Part7-Database/49-index.md) | 为什么能加速查询？代价是什么？ |
| 50 | [数据库锁](./docs/Part7-Database/50-db-lock.md) | 并发访问下如何保证正确？ |
| 51 | [ORM](./docs/Part7-Database/51-orm.md) | 对象与关系之间的鸿沟如何弥合？ |
